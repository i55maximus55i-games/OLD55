...
function love.load(args)
    ...
    local x = 80
    local y = 250
    platform_create(x + 150 * 1, y + 150 * 0, 150, 150)
    platform_create(x + 150 * 1, y + 150 * 1, 150, 150)

    platform_create(x + 150 * 1, y + 150 * 4, 300, 150)
    -- platform_create(x + 150 * 1, y + 150 * 4, 150, 150)

    platform_create(x + 150 * 5, y + 150 * 3, 450, 150)
    platform_create(x + 150 * 5, y + 150 * 1, 450, 50)
    -- platform_create(x + 150 * 4, y + 150 * 3, 150, 150)
    -- platform_create(x + 150 * 5, y + 150 * 3, 150, 150)

    platform_create(x + 150 * 8.5, y + 150 * 4, 300, 150)
    -- platform_create(x + 150 * 8, y + 150 * 4, 150, 150)

    platform_create(x + 150 * 8.5, y + 150 * 0, 150, 150)
    platform_create(x + 150 * 8.5, y + 150 * 1, 150, 150)
end
